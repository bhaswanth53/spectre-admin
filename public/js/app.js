...
var Main = /*#__PURE__*/function () {
  ...
  _createClass(Main, [{
    ...
    key: "handleLeftBar",
    value: function handleLeftBar() {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.leftbar-link', function (e) {
        e.preventDefault();
        var tab = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('href');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#left-bar .nav-item.active").removeClass('active');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().addClass('active');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#left-bar-2 .leftbar-content.show").removeClass('show');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(tab).addClass('show');
      });
    }
  }]);
  return Main;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkspectre_admin"] = self["webpackChunkspectre_admin"] || [];
